    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Recibimos una solicitud para restablecer la contraseña de tu cuenta AprendeYa.</p>
...
def _enviar_correo_verificacion(request, user: User) -> None:
    ...
    send_mail(
        subject='Verifica tu correo - AprendeYa',
...
def solicitar_recuperacion(request):
    if request.method == 'POST':
        ...
        try:
            send_mail(
                subject='Recuperación de contraseña - AprendeYa',
...
def confirmar_recuperacion(request, uidb64: str, token: str):
    ...
    if request.method == 'POST':
        ...
        try:
            send_mail(
                subject='Contraseña actualizada - AprendeYa',
