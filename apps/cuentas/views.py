    ...
    <body>
        <div class="container">
            ...
            <div class="content">
                ...
                <p>Recibimos una solicitud para restablecer la contraseña de tu cuenta AprendoYa.</p>
            ...
            <div class="footer">
                <p>© 2026 AprendoYa. Todos los derechos reservados.</p>
            </div>
        </div>
    </body>
    </html>
...
def _enviar_correo_verificacion(request, user: User) -> None:
    ...
    send_mail(
        subject='Verifica tu correo - AprendoYa',
...
def solicitar_recuperacion(request):
    if request.method == 'POST':
        ...
        try:
            send_mail(
                subject='Recuperación de contraseña - AprendoYa',
...
def confirmar_recuperacion(request, uidb64: str, token: str):
    ...
    if request.method == 'POST':
        ...
        try:
            send_mail(
                subject='Contraseña actualizada - AprendoYa',
